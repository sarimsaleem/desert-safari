...
const LuxuryDesertSafari = () => {
    // const tour = desertSafaris[2];
    const filteredTours = data.filter(tour => tour.category.includes("Luxury Desert Safari"));
...
export default LuxuryDesertSafari