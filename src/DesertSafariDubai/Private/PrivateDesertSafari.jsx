...
const PrivateDesertSafari = () => {
  
  const filteredTours = data.filter(tour => tour.category.includes("Private Desert Safari, Pick & Drop Service & Dinner Included"));
...
export default PrivateDesertSafari