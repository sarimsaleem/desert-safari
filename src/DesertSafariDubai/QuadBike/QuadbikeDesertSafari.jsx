...
const QuadbikeDesertSafari = () => {

  const filteredTours = data.filter(tour => tour.category.includes("Desert Safari With Quad Bike (Gold)"));
...
export default QuadbikeDesertSafari