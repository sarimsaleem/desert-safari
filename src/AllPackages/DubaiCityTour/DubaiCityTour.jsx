...
import "./dubaicitytour.css"
import { useNavigate } from 'react-router-dom'
import data from "../JsonData/DubaiCityTour.json"
...
const DubaiCityTour = () => {
  ...
  return (
    <div className="dubaicitytour">
      <div className="image-detail-container">
        <img src={header} alt="" />
        <div className="image-text-container">
          <h6 className='image-detail-text fs-1'>Dubai City tour packages</h6>
        </div>
      </div>
