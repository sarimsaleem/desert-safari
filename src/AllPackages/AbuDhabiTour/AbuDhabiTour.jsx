...
import "./abudhabitour.css"
import data from "../JsonData/AbuDhabiTour.json"
...
const AbuDhabiTour = () => {
  ...
  return (
    <div className="abudhabitour">
      <div className="image-detail-container">
        <img src={header} alt="" />
        <div className="image-text-container">
          <h6 className='image-detail-text fs-1'>Abu Dhabi City Tour</h6>
        </div>
      </div>
