...
import "./cruisedinner.css"
import data from "../JsonData/CruiseDinner.json"
    ...
    <div className="cruiseDinner">
      <div className="image-detail-container">
        ...
        <div className="image-text-container">
          <h6 className='image-detail-text fs-1'>Best Dinner Cruise Package For Dubai Marina Dhow</h6>
        </div>
      </div>
